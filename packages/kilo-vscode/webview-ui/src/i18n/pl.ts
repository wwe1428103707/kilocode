...
export const dict = {
  ...
  "deviceAuth.title": "Zaloguj się do LingInk Agent",
  ...
  "profile.action.login": "Zaloguj się przez LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "O LingInk Agent",

  "session.messages.empty": "Rozpocznij rozmowę, wpisując wiadomość poniżej.",
  "session.messages.welcome":
    "LingInk Agent to asystent programowania AI. Poproś go o tworzenie funkcji, naprawę błędów lub wyjaśnienie bazy kodu.",
  ...
  "settings.aboutKiloCode.extensionName": "Rozszerzenie LingInk Agent",
  ...
  "settings.language.description": 'Wybierz język interfejsu LingInk Agent. „Auto" używa języka wyświetlania VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migruj ustawienia z poprzedniej instalacji LingInk Agent, w tym klucze API dostawców i domyślny model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Co nowego w LingInk Agent",
