...
export const dict = {
  ...
  "deviceAuth.title": "Sign in to LingInk Agent",
  ...
  "profile.action.login": "Login with LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "About LingInk Agent",

  "session.messages.empty": "Start a conversation by typing a message below.",
  "session.messages.welcome":
    "LingInk Agent is an AI coding assistant. Ask it to build features, fix bugs, or explain your codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "LingInk Agent Extension",
  ...
  "settings.language.description":
    'Choose the language for the LingInk Agent UI. "Auto" uses your VS Code display language.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrate settings from a previous installation of LingInk Agent, including provider API keys and default model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "What's New in LingInk Agent",
