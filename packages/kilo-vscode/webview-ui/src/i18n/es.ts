...
export const dict = {
  ...
  "deviceAuth.title": "Iniciar sesión en LingInk Agent",
  ...
  "profile.action.login": "Iniciar sesión con LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "Acerca de LingInk Agent",

  "session.messages.empty": "Inicia una conversación escribiendo un mensaje a continuación.",
  "session.messages.welcome":
    "LingInk Agent es un asistente de programación con IA. Pídele que cree funcionalidades, corrija errores o explique tu código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensión LingInk Agent",
  ...
  "settings.language.description":
    'Elige el idioma de la interfaz de LingInk Agent. "Auto" utiliza el idioma de visualización de VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra la configuración de una instalación anterior de LingInk Agent, incluyendo las claves API de proveedores y el modelo predeterminado.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Novedades en LingInk Agent",
