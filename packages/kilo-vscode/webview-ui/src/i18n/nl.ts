...
export const dict = {
  ...
  "deviceAuth.title": "Meld je aan bij LingInk Agent",
  ...
  "profile.action.login": "Inloggen met LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "Over LingInk Agent",

  "session.messages.empty": "Start een gesprek door hieronder een bericht te typen.",
  "session.messages.welcome":
    "LingInk Agent is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.aboutKiloCode.extensionName": "LingInk Agent Extensie",
  ...
  "settings.language.description": 'Kies de taal voor de LingInk Agent UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van LingInk Agent, inclusief provider API-sleutels en standaard model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in LingInk Agent",
