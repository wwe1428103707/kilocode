...
export const dict = {
  ...
  "deviceAuth.title": "Bei LingInk Agent anmelden",
  ...
  "profile.action.login": "Mit LingInk Agent anmelden",
  ...
  "settings.aboutKiloCode.title": "Über LingInk Agent",

  "session.messages.empty": "Starten Sie eine Unterhaltung, indem Sie unten eine Nachricht eingeben.",
  "session.messages.welcome":
    "LingInk Agent ist ein KI-Programmierassistent. Bitten Sie ihn, Funktionen zu erstellen, Fehler zu beheben oder Ihre Codebasis zu erklären.",
  ...
  "settings.aboutKiloCode.extensionName": "LingInk Agent Erweiterung",
  ...
  "settings.language.description":
    'Wählen Sie die Sprache für die LingInk Agent Oberfläche. „Auto" verwendet die VS Code Anzeigesprache.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrieren Sie Einstellungen von einer früheren Installation von LingInk Agent, einschließlich Anbieter-API-Schlüsseln und dem Standardmodell.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Neuigkeiten in LingInk Agent",
