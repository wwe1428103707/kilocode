...
export const dict = {
  ...
  "deviceAuth.title": "Log ind på LingInk Agent",
  ...
  "profile.action.login": "Log ind med LingInk Agent",
  ...
  "session.messages.welcome":
    "LingInk Agent er en AI-kodningsassistent. Bed den om at bygge funktioner, rette fejl eller forklare din kodebase.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer indstillinger fra en tidligere installation af LingInk Agent, herunder udbyder API-nøgler og standardmodel.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nyheder i LingInk Agent",
