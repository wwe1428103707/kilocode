...
export const dict = {
  ...
  "deviceAuth.title": "Entrar no LingInk Agent",
  ...
  "profile.action.login": "Entrar com LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "Sobre o LingInk Agent",

  "session.messages.empty": "Inicie uma conversa digitando uma mensagem abaixo.",
  "session.messages.welcome":
    "LingInk Agent é um assistente de programação com IA. Peça para criar funcionalidades, corrigir bugs ou explicar sua base de código.",
  ...
  "settings.aboutKiloCode.extensionName": "Extensão LingInk Agent",
  ...
  "settings.language.description":
    'Escolha o idioma da interface do LingInk Agent. "Auto" usa o idioma de exibição do VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migre as configurações de uma instalação anterior do LingInk Agent, incluindo chaves de API de provedor e modelo padrão.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "O Que Há de Novo no LingInk Agent",
