...
export const dict = {
  ...
  "deviceAuth.title": "تسجيل الدخول إلى LingInk Agent",
  ...
  "profile.action.login": "تسجيل الدخول باستخدام LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "حول LingInk Agent",

  "session.messages.empty": "ابدأ محادثة بكتابة رسالة أدناه.",
  "session.messages.welcome":
    "LingInk Agent هو مساعد ترميز بالذكاء الاصطناعي. اطلب منه بناء ميزات أو إصلاح أخطاء أو شرح قاعدة الشيفرة.",
  ...
  "settings.aboutKiloCode.extensionName": "إضافة LingInk Agent",
  ...
  "settings.language.description": 'اختر اللغة لواجهة LingInk Agent. "تلقائي" يستخدم لغة عرض VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ترحيل الإعدادات من تثبيت سابق لـ LingInk Agent، بما في ذلك مفاتيح API لمقدمي الخدمة والنموذج الافتراضي.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "ما الجديد في LingInk Agent",
