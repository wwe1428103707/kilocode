...
export const dict = {
  ...
  "deviceAuth.title": "Accedi a LingInk Agent",
  ...
  "profile.action.login": "Accedi con LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "Informazioni su LingInk Agent",
  "session.messages.empty": "Avvia una conversazione scrivendo un messaggio qui sotto.",
  "session.messages.welcome":
    "LingInk Agent è un assistente AI per il coding. Chiedigli di creare feature, correggere bug o spiegare il codebase.",
  ...
  "settings.aboutKiloCode.extensionName": "Estensione LingInk Agent",
  ...
  "settings.language.description": 'Scegli la lingua dell\'interfaccia LingInk Agent. "Auto" usa la lingua di VS Code.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migra le impostazioni da una precedente installazione di LingInk Agent, incluse API key dei provider e modello predefinito.",
  ...
  "migration.whatsNew.title": "Novità in LingInk Agent",
