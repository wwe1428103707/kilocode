...
export const dict = {
  ...
  "deviceAuth.title": "Войти в LingInk Agent",
  ...
  "profile.action.login": "Войти через LingInk Agent",
  ...
  "settings.aboutKiloCode.title": "О LingInk Agent",

  "session.messages.empty": "Начните разговор, введя сообщение ниже.",
  "session.messages.welcome":
    "LingInk Agent — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.aboutKiloCode.extensionName": "Расширение LingInk Agent",
  ...
  "settings.language.description": "Выберите язык интерфейса LingInk Agent. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки LingInk Agent, включая API-ключи провайдеров и модель по умолчанию.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в LingInk Agent",
