...
export const dict = {
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "LingInk Agent Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.disabled": "LingInk Agent Autocomplete (disabled)",
  ...
  "kilocode:autocomplete.toggleMessage": "LingInk Agent Autocomplete {{status}}",
  "kilocode:autocomplete.progress.title": "LingInk Agent",
  ...
  "kilocode:autocomplete.input.title": "LingInk Agent: Quick Task",
  "kilocode:autocomplete.input.placeholder": "e.g., 'refactor this function to be more efficient'",
  "kilocode:autocomplete.commands.generateSuggestions": "LingInk Agent: Generate Suggested Edits",
  ...
  "kilocode:autocomplete.commands.category": "LingInk Agent",
  "kilocode:autocomplete.codeAction.title": "LingInk Agent: Suggested Edits",
  "kilocode:autocomplete.chatParticipant.fullName": "LingInk Agent Agent",
  ...
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The LingInk Agent Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "LingInk Agent Autocomplete has been paused because your account has no remaining credits. Add credits to resume autocomplete.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Add Credits",
  "kilocode:autocomplete.authError.message":
    "LingInk Agent Autocomplete has been paused due to an authentication error. Please sign in again.",
}
